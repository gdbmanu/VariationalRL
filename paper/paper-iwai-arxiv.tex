...
the sensory data. %, and train an inverse model that fits the action to the objective.
...
%Given a set of pre-defined actions, all you have to do is just pick the one that matches the most the input.  
...
\centerline{
	\includegraphics[width = .4 \linewidth]{env-1.pdf} 
}
...
\begin{figure}[t]
	\begin{subfigure}[b]{0.5\textwidth}
		\centerline{\bf (A)}
		\centerline{
			\includegraphics[width = \linewidth]{botteneck-baseline.png} 		
		}
		\centerline{\bf (B)}
		\centerline{\includegraphics[width = \linewidth]{botteneck-uniform-drive.png} }
		%\label{fig:explore}
	...
	\begin{subfigure}[b]{0.4\textwidth}
		\centerline{\includegraphics[width=.8\textwidth]{training-comparison.png}}
		%\label{fig:compare}
