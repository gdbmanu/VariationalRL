#!/bin/csh
set env_name=walker
set envir=BipedalWalker-v3
set BETA_REF=30 # reward amplification
set k=100 # explo/exploit balance
set PREC=$k/10
set do_reward=1
set gamma=0.99
set bandwidth=0.03
...
#nice python -m spinup.run ppo --seed 0 1 2 3 4 --hid "[$hid,$hid]" --env $envir --exp_name walker_ppo_test --gamma $gamma --epochs $epochs --steps_per_epoch $steps_per_epoch --max_ep_len $max_ep_len&
